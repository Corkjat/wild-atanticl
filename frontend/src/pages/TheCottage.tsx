...
export default function TheCottage() {
  return (
    <>
      <HeroSlider images={sliderImages} overlayImage="/images/perfect-home-text.png" />
          ...
          <div className="two-col">
            <div className="col-main">
              ...
              <div className="notice">
                <strong>Please note:</strong> Wild Atlantic Way Cottage is a non-smoking household.
                Strictly no pets allowed. Strictly no hen/stag parties. Additional charges (which
                are metered) apply for heating and electricity.
              </div>
            </div>
